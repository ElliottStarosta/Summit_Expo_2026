...
const PHOTOS = [
  { src: "/gallery/robotics_demo.webp", caption: "FIRST Robotics Demo" },
  {
    src: "/gallery/icecream.webp",
    caption: "Liquid-nitrogen ice cream!",
  },
  { src: "/gallery/stage.webp", caption: "A night of tech talks" },
  { src: "/gallery/interlude.webp", caption: "STEM Fair at the Summit" },
];
...
export function GalleryBridge() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // GSAP owns the hidden state — no CSS opacity:0 needed
      gsap.set(s.querySelector(".gb-eyebrow"), { opacity: 0, y: 20 });
      gsap.set(s.querySelector(".gb-headline"), { opacity: 0, y: 30 });
      gsap.set(s.querySelector(".gb-sub"), { opacity: 0, y: 16 });
      gsap.set(s.querySelectorAll(".gb-photo-wrap"), {
        opacity: 0,
        y: 50,
        scale: 0.92,
      });
      gsap.set(s.querySelectorAll(".gb-caption"), { opacity: 0, y: 10 });
      gsap.set(s.querySelectorAll(".gb-desig"), { opacity: 0 });
      gsap.set(s.querySelectorAll(".gb-corner"), { opacity: 0, scale: 0 });
      ...
      ScrollTrigger.create({
        ...
        animation: gsap
          ...
          .to(
            s.querySelector(".gb-headline"),
            { opacity: 1, y: 0, duration: 0.75, ease: "power3.out" },
            "<0.1",
          )
          .to(
            s.querySelector(".gb-sub"),
        ...
        onEnter() {
          ...
          gsap.fromTo(
            ...
            { scaleX: 0 },
            {
              ...
              delay: 0.35,
              onComplete() {
                gsap.to(s.querySelectorAll(".gb-scan"), {
                  opacity: 0,
                  duration: 0.4,
                  stagger: 0.08,
                });
          ...
          gsap.to(s.querySelectorAll(".gb-corner"), {
            opacity: 1,
            scale: 1,
            stagger: 0.03,
            duration: 0.25,
          ...
          gsap.to(s.querySelectorAll(".gb-caption"), {
            opacity: 1,
            y: 0,
            stagger: 0.12,
            duration: 0.45,
          ...
          gsap.to(s.querySelectorAll(".gb-desig"), {
            opacity: 1,
            stagger: 0.1,
            duration: 0.4,
            delay: 0.7,
